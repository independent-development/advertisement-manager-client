...
export default function EditBannerFixedPosition(props) {
  ...
  return (
    <PageContainer
      content={`首页Banner位固定广告-${search_params.get("position_id")}`}
...
EditBannerFixedPosition.propTypes = {


};
EditBannerFixedPosition.defaultProps = {
